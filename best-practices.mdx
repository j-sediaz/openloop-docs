...
<Tabs>
  <Tab title="Production" icon="globe">
    **Base URL**: `https://api-staging.openloophealth.com`  
    Use this for live integrations with real patient data
  </Tab>
  <Tab title="Staging" icon="flask">
    **Base URL**: `https://staging-api-staging.openloophealth.com`  
...
const response = await fetch('https://api-staging.openloophealth.com/patients', {
  method: 'GET',
  headers: {
...
const response = await limiter.makeRequest('https://api-staging.openloophealth.com/patients');
```
...
data = await limiter.make_request('https://api-staging.openloophealth.com/patients')
```
</CodeGroup>
...
```bash
# Seed test patients
curl -X POST "https://api-staging.openloophealth.com/patients/seed?count=5" \
  -H "x-api-key: YOUR_API_KEY"

# Reset data after testing
curl -X POST "https://api-staging.openloophealth.com/patients/reset" \
  -H "x-api-key: YOUR_API_KEY"
```
